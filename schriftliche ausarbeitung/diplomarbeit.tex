...
The team of \citet{claypool2001} measured the time a user spends on a website as a first indicator that the user works with the site.
...
Therefore other indicators where measured and included in \citet{claypool2001} research.
