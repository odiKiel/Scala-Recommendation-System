...
This is a common rating scale for websites and, thus, the results of this thesis can be compared with other works in the same field. %\todo{check sentence}
...
Therefore the keywords of the item content are used as tags in order to reflect the subject of the items. %\todo{improve}
