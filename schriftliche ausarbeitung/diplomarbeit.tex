...
The technique of the \emph{levenshtein automaton} is explained in more detail.
...
A word with a length of $n\leq3$ in the STW is usually an abbreviation and therefore is only used as a direct match.
...
Besides the content-based systems have the disadvantage that they do not make use of the information whether or not a user likes a document.
...
So, more information about the user's interest is available before the actual recommendations can be calculated.
